...
@section('content')
    ...
    <div style="text-align: center; margin: 35px 0;">
        <a href="{{ $url }}" style="background: var(--primary-color); color: white; text-decoration: none; padding: 14px 30px; border-radius: 6px; font-weight: 600; display: inline-block; transition: all 0.2s ease;">Verify Email Address</a>
    </div>

    <p>This verification link will expire in 24 hours. If you did not create an account with Drishti Pulse, please ignore this email.</p>
...
<head>
    ...
    <title>Verify Your Email - DRISHTI PULSE</title>
</head>
                    ...
                    <tr>
                        <td style="text-align: center; background: #3490dc; padding: 30px 20px; border-radius: 12px 12px 0 0;">
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                ...
                                <tr>
                                    <td>
                                        <h1 style="color: white; margin: 20px 0 0 0; font-size: 28px; font-weight: 600;">Verify Your Email</h1>
                                    </td>
                                </tr>
                            </table>
                        </td>
