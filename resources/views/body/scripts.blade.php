...
$(document).on('click', '.subuser-button', function (e) {
    ...
    let parentUserId = $(this).data('user-id');
    let parentUserName = $(this).data('user-name');
    let parentUserEmail = $(this).data('user-email');

    // Update header and open sidebar
    $('#sidebarSubuser').text(`${parentUserName} (${parentUserEmail})`);
