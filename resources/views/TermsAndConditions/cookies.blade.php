...
@section('content')
    <section id="terms" class="py-5 bg-light">
        <div class="container terms-content mt-5">
            ...
            <p>The words with their initial letter capitalized have specific meanings as defined below. These definitions
                apply whether the terms appear in singular or plural..</p>
            <h3>Definitions</h3>
            <p>For the purposes of this Cookies Policy:</p>
            <ul>
                <li><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                    or &quot;Our&quot; in this Cookies Policy) refers to Drishti pulse.</li>
                ...
                <li><strong>Website</strong> refers to Drishti pulse, accessible from <a href="https://drishtipulse.in/"
                        rel="external nofollow noopener" target="_blank">https://drishtipulse.in/</a></li>
            ...
            <p>We use a combination of session and persistent cookies for different purposes, including development and
                security:</p>
            <ul>
                <li>
                ...
                <li>
                    ...
                    <p>Purpose:Monitor website traffic and performance.Help improve user experience by tracking user
            ...
            <ul>
                <li>By visiting this page on our website: <a href="https://drishtipulse.in/"
                        rel="external nofollow noopener" target="_blank">https://drishtipulse.in/</a></li>
            </ul>
        </div>
    </section>
